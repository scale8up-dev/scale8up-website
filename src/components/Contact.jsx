...
export default function Contact() {
  return (
    <div className="p-[50px]" id="contact">
      <div className="w-full bg-white rounded-[20px] py-[110px]">
        <div className="max-w-[1300px] mx-auto px-5">
          <div className="grid grid-cols-2 gap-5">
            <div className="border border-[#dcdcdc] p-10 rounded-[20px]">
              <span
            ...
            <div className="border border-[#dcdcdc] py-[50px] pl-[30px] pr-[75px] rounded-[20px] ">
              <div className="font-bold text-[40px] leading-[50px] mb-5">
                Send us a message
              </div>
              ...
              <form>
                <div className="flex mt-[30px] gap-[15px]">
                  <input type="text" placeholder="First Name *" className="border border-[#dcdcdc] rounded-[15px] py-[15px] pl-5 w-1/2"/>
                   <input type="text" placeholder="Last Name *" className="border border-[#dcdcdc] rounded-[15px] py-[15px] pl-5 w-1/2"/>
                </div>
